...
#load packages
packages = c("tidyverse", "broom", "sjPlot", "rsample", "here")
lapply(packages, library, character.only = TRUE)
rm(packages)

load("data/impute_pca/cleaned.Rdata")
...
save(male_reg, male_plot, file = "data/regression_impute_male.Rdata")
...
save(female_reg, female_plot, file = "data/regression_impute_female.Rdata")
